...
function Footer() {
    return ( 
      <footer style={{backgroundColor:"(240,240,240)"}}>
       <div className='container border-top mt-5 ' >
        <div className='row mt-5' >
            <div className='col'>
                <img src='/media/Images/logo.svg' alt='Zerodha Logo' className='img-fluid mt-5' style={{width:"80%"}}/>
