      ...
      <div className="row p-5 mt-5 border-top text-muted " style={{lineHeight:"1.8", fontSize:"1.2em"}}>
        ...
        <div className="col-6 ">
          <p>
            ...
            <p>
            We are also the parent company of <a href="" style={{textDecoration:"none"}}>Rainmatter</a>, a fintech fund and <a href="" style={{textDecoration:"none"}}>Rainmatter</a>, our fintech fund and incubator, has invested in several
